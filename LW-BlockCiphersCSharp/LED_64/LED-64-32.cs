...
namespace LW_BlockCiphersCSharp
{
    class LED_64_32
    {
        ...
        static uint keySizeConst = 0x03020504;
        static uint[] RCandKeySizeConst = new uint[] {
            0x13021504, 0x33023504, 0x73027504, 0x73127514, 0x73327534, 0x63726574, 0x53725574, 0x33723574, 0x73627564, 0x73527554,
        ...
        static void EncryptOneBlock(ref uint[] state, uint[] sk0)
        {
            for (int i = 0; i < 8; i++)
            {
